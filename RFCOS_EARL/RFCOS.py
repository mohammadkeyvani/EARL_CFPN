...
#? کار: نرمال‌سازی یک تنسور بین 0 و 1.

def to0_1(tensor):
    return (tensor - tensor.min())/(tensor.max() - tensor.min())

# ! تبدیل لایه های ویژگی از شبکه
...
# !! خروجی کانولوشن head را از حالت feature-map به لیست anchorها تبدیل می‌کند تا قابل استفاده برای loss و inference شود.
